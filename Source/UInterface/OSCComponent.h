...
{
public:
	//OSCComponent(juce::AudioProcessorValueTreeState& apvts, juce::String waveSelID, juce::String modSelID, juce::String fmFreqID, juce::String fmDepthID, const int numberOsc);
	OSCComponent(juce::AudioProcessorValueTreeState& apvts, juce::String statusID, juce::String waveSelID, juce::String modINID, juce::String modOutID, juce::String fmFreqID, juce::String fmDepthID, juce::String oscVolume, juce::String oscFreq, const int numberOsc);
...
private:
	...
	std::unique_ptr<AttachComboBox> attachOscWaveSel;
	...
	void setSliderSize(juce::Slider& slider, Slider::TextEntryBoxPosition textBoxPosition, juce::Label& label, juce::AudioProcessorValueTreeState& apvts, juce::String paramID, std::unique_ptr<AttachSlider>& attach, juce::String valueSuffix) {
	...
	void setComboBoxSize(juce::ComboBox& comboBox, juce::AudioProcessorValueTreeState& apvts, juce::String paramID, std::unique_ptr<AttachComboBox>& attachComboBox) {
		addAndMakeVisible(comboBox);

		attachComboBox = std::make_unique<juce::AudioProcessorValueTreeState::ComboBoxAttachment>(apvts, paramID, comboBox);
	};
