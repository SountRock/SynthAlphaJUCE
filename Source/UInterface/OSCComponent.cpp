...
//==============================================================================
OSCComponent::OSCComponent(juce::AudioProcessorValueTreeState& apvts, juce::String statusID, juce::String waveSelID, juce::String modINID, juce::String modOutID, juce::String fmFreqID, juce::String fmDepthID, juce::String oscFreqID, juce::String oscVolumeID, const int numberOsc)
{
	this->numberOsc = numberOsc;

	oscNumber.setText("Osc " + String(numberOsc), juce::dontSendNotification);
	...
	setComboBoxSize(oscWaveSel, apvts, waveSelID, attachOscWaveSel);
...
{
	oscNumber.setBounds(0, 0, getWidth() / 2, getHeight() * 0.0625);
	statusButton.setBounds(oscNumber.getX() + oscNumber.getWidth(), 0, getWidth() / 2, getHeight() * 0.0625);
	oscWaveSel.setBounds(0, oscNumber.getY() + oscNumber.getHeight(), getWidth() / 2, getHeight() * 0.0625);
	modOscSel.setBounds(oscWaveSel.getX() + oscWaveSel.getWidth(), oscNumber.getY() + oscNumber.getHeight(), getWidth() / 2, getHeight() * 0.0625);

	freqLabel.setBounds(getWidth() / 4, oscWaveSel.getY() + oscWaveSel.getHeight() + 10, getWidth() / 2, getHeight() * 0.0625);
